...
class Post
{
	...
	public function get_posts($id,$post_type = "profile")
	{
		...
		$query = "select * from posts where parent = 0 and owner = 0 and userid = '$id' order by id desc";
    ...
    public function get_limit_comments($id)
	{
		$limit = 2;

		$query = "select * from posts where parent = '$id' order by id desc limit $limit ";
